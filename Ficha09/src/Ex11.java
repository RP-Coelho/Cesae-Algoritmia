    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 5:
                    System.out.println("\n**** Empréstimo ****");
                    System.out.println("Qual o valor pedido");
                    double valor = input.nextDouble();
                   if(id1.pedirEmprestimo(valor)){
                       System.out.println("Feito com sucesso!");
                   }else{
                       System.out.println("Erro na transferencia");
                       if(id1.getValorDivida()<0){
                           System.out.println("Tem valor em divida: "+ id1.getValorDivida());
                       }else{
                           if (id1.getMargemEmprestimo()<valor){
                               System.out.println("A margem de emprestimo não permite: "+id1.getMargemEmprestimo());
                           }
                       }
                   }
                    break;
